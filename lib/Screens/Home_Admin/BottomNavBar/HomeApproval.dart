...
class HomeApproval extends StatefulWidget {
  ...
  const HomeApproval({Key key, this.host, this.list}) : super(key: key);
  @override
                      ...
                      onTap: () => Navigator.of(context).push(
                          new MaterialPageRoute(
                              ...
                              new ApprovalScreen2(
                                ...
                                sign: widget.list[0]['user_signature']
                              ))),
                      child: Container(
                        decoration: new BoxDecoration(
                            border: Border(
                      ...
                      onTap: () => Navigator.of(context).push(
                          new MaterialPageRoute(
                              ...
                              new ApprovalScreen2(
                                  ...
                                  image: _requestDetails[i].user_image,
  ...
  onSearchTextChanged(String text) async {
    ...
    _requestDetails.forEach((requestDetail) {
      ...
      if (requestDetail.title.toLowerCase().contains(text.toLowerCase()) ||
          ...
          requestDetail.departmentname.toLowerCase().contains(text.toLowerCase()))
